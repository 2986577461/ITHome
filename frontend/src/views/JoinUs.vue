...
const benefits = [
  { icon: '<svg viewBox="0 0 32 32" fill="none"><rect x="4" y="6" width="24" height="20" rx="3" stroke="currentColor" stroke-width="1.5"/><path d="M14 16l3 3 5-6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>', title: "计算机学习教学", desc: "提供大一所应具备的计算机知识，如C/C++、前端、数据结构与算法、MySQL数据库、Java、Python/AI" },

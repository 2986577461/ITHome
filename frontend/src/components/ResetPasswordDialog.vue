<template>
  <div
    class="modal-overlay"
    v-if="visibleStore.resetPasswordVisible"
    @click.self="visibleStore.resetPasswordVisible = false"
  >
    <div class="modal-card">
      <button
        class="modal-close"
        @click="visibleStore.resetPasswordVisible = false"
      >
      ...
      <form @submit.prevent="handleSubmit" class="dialog-form">
        ...
        <button type="submit" class="btn-primary dialog-submit">
          确认修改
        </button>
      </form>
    </div>
